...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
  ...
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="#" target="_blank">
      ...
      <span class="ms-1 font-weight-bold text-white">Admin  | <?=  $current_user_name  ?> </span>
    </a>
  </div>
...
<li class="nav-item">
  <a class="nav-link text-white " href="./userCat.php">
    
      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        <i class="material-icons opacity-10">table_view</i>
      </div>
    
    <span class="nav-link-text ms-1">User Categury</span>
  </a>
</li>
<li class="nav-item">
...
<li class="nav-item">
  <a class="nav-link text-white " href="./users.php">
    ...
    <span class="nav-link-text ms-1">Requirements manag</span>
  </a>
...
<li class="nav-item">
  <a class="nav-link text-white " href="Location : /../logout.php">
